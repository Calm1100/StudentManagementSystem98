...
from student_management_app.models import Subjects, SessionYearModel, Students, AttendanceReport, Attendance, Staffs, \
...
def get_attendance_dates(request):
    ...
    session_year_id = request.POST.get('session_year_id')
    subject_obj = Subjects.objects.get(id=subjects)
